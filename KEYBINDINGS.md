...
ShioriCode reads keybindings from:

- Desktop/prod default: `~/.shiori/userdata/keybindings.json`
- Root dev commands default: `~/.shiori/dev/keybindings.json`
...
- `browser.toggle`: open/close the integrated Browser panel
