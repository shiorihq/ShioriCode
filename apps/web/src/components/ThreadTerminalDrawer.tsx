...
import { getDocumentTerminalThemeColors } from "../lib/theme";
          ...
          {hasTerminalSidebar && (
            <aside className="flex w-40 min-w-40 flex-col border-l border-border/60 bg-background/50 text-[11px]">
              <div className="flex h-[22px] items-center justify-end gap-px border-b border-border/60 px-1">
                ...
                <TerminalActionButton
                  className="inline-flex size-[18px] items-center justify-center rounded-sm text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
                  onClick={onNewTerminalAction}
                  label={newTerminalActionLabel}
                >
                ...
                <TerminalActionButton
                  className="inline-flex size-[18px] items-center justify-center rounded-sm text-muted-foreground transition-colors hover:bg-destructive/10 hover:text-destructive-foreground"
                  onClick={() => onCloseTerminal(resolvedActiveTerminalId)}
                  label={closeTerminalActionLabel}
                >
                  ...
                  return (
                    ...
                    >
                      {showGroupHeaders && (
                        <button
                          type="button"
                          className={`flex w-full items-center gap-1 rounded-sm px-1 py-0.5 transition-colors ${
                            isGroupActive
                        ...
                        <div className="ml-1 border-l border-border/60 pl-1.5 mt-px space-y-px">
                          {terminalGroup.terminalIds.map((terminalId) => {
                            ...
                            return (
                              ...
                              >
                                <span className="pl-0.5 leading-none text-muted-foreground/70">
                                  └
                                </span>
                                <button
                                  type="button"
                                  ...
                                  <Popover>
                                    <PopoverTrigger
                                      ...
                                      render={
                                        <button
                                          type="button"
                                          className="mr-0.5 inline-flex size-4 items-center justify-center rounded-sm text-muted-foreground/70 opacity-0 transition hover:bg-accent hover:text-foreground group-hover:opacity-100"
                          ...
                          return (
                            !showGroupHeaders && (
                              ...
                              >
                                <button
                                  type="button"
                                  className="flex min-w-0 flex-1 items-center gap-1.5 px-1.5 py-0.5 text-left"
                                  onClick={() => onActiveTerminalChange(terminalId)}
                                >
