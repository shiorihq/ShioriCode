import { ProjectId, type ModelSelection, type ThreadId, type TurnId } from "contracts";
...
export const LAST_INVOKED_SCRIPT_BY_PROJECT_KEY = "shioricode:last-invoked-script-by-project";
