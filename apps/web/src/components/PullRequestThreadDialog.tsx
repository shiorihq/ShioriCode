    ...
    >
      <DialogPopup className="max-w-xl">
        ...
        <DialogPanel className="space-y-4">
          ...
          {resolvedPullRequest ? (
            <div className="rounded-xl border border-hairline bg-muted/24 p-3">
          ...
          {isResolving ? (
            <div className="flex items-center gap-2 text-muted-foreground text-xs">
              <LoadingText>Resolving pull request</LoadingText>
            </div>
          ) : null}
        ...
        <DialogFooter>
          ...
          >
            {preparingMode === "local" ? <LoadingText>Preparing local</LoadingText> : "Local"}
          </Button>
          <Button
            type="button"
            size="sm"
          ...
          >
            {preparingMode === "worktree" ? (
              <LoadingText>Preparing worktree</LoadingText>
            ) : (
              "Worktree"
            )}
          </Button>
