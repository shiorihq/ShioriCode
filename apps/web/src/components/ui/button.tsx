  ...
  "[&_svg]:-mx-0.5 relative inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-md border font-medium text-base outline-none transition-shadow before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] pointer-coarse:after:absolute pointer-coarse:after:size-full pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-64 sm:text-sm [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    ...
    variants: {
      ...
      variant: {
        ...
        "destructive-outline":
          "border-border/72 bg-transparent text-destructive-foreground dark:bg-input/16 dark:border-border [:hover,[data-pressed]]:border-destructive/40 [:hover,[data-pressed]]:bg-destructive/8",
        ghost:
          "border-transparent text-foreground data-pressed:bg-accent [:hover,[data-pressed]]:bg-accent",
        link: "border-transparent underline-offset-4 [:hover,[data-pressed]]:underline",
        outline:
          "border-border/72 bg-transparent text-foreground/85 dark:border-border dark:bg-input/16 [:hover,[data-pressed]]:border-border [:hover,[data-pressed]]:bg-accent/50 [:hover,[data-pressed]]:text-foreground dark:[:hover,[data-pressed]]:bg-input/40",
        secondary:
