...
/** Any positive overflow (after gap) should switch to compact footer — small overflows still clip at high zoom. */
const COMPOSER_FOOTER_OVERFLOW_FORCE_COMPACT_EPSILON_PX = 0.5;
...
export function shouldForceCompactComposerFooterForFit(input: {
  ...
  return overflowPx > COMPOSER_FOOTER_OVERFLOW_FORCE_COMPACT_EPSILON_PX;
}
