import { type ProjectEntry, type ProviderKind } from "contracts";
...
export const ComposerCommandMenu = memo(function ComposerCommandMenu(props: {
  ...
  return (
    <Command
      autoHighlight={false}
      mode="none"
      onItemHighlighted={(highlightedValue: unknown) => {
    ...
    >
      <div
        ...
        className="relative overflow-hidden rounded-xl border border-hairline bg-popover/96 shadow-lg/8 backdrop-blur-xs"
      >
