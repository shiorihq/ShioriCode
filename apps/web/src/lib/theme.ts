...
const BUILT_IN_THEME_RECORDS: readonly ThemeRecord[] = [
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      mutedForeground:
        "color-mix(in srgb, color-mix(in srgb, var(--color-neutral-500) 90%, var(--color-black)) 80%, var(--background))",
  ...
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      mutedForeground:
        "color-mix(in srgb, color-mix(in srgb, var(--color-neutral-500) 90%, var(--color-white)) 80%, var(--background))",
  ...
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      muted: "#e6e9ef",
      mutedForeground: "color-mix(in srgb, #6c6f85 80%, var(--background))",
      accent: "#ccd0da",
  ...
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      muted: "#1e1e2e",
      mutedForeground: "color-mix(in srgb, #a6adc8 80%, var(--background))",
      accent: "#45475a",
  ...
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      muted: "#d5d6db",
      mutedForeground: "color-mix(in srgb, #6172b0 80%, var(--background))",
      accent: "#b7c0e0",
  ...
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      muted: "#1f2335",
      mutedForeground: "color-mix(in srgb, #9aa5ce 80%, var(--background))",
      accent: "#2b3047",
  ...
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      muted: "#F0F0ED",
      mutedForeground: "color-mix(in srgb, #5C5C57 80%, var(--background))",
      accent: "#E8E8E3",
  ...
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      muted: "#353533",
      mutedForeground: "color-mix(in srgb, #A8A8A3 80%, var(--background))",
      accent: "#3D3D3A",
  ...
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      muted: "#F5F5F5",
      mutedForeground: "color-mix(in srgb, #5C5C5C 80%, var(--background))",
      accent: "#EAEAEA",
  ...
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      muted: "#1A1A1A",
      mutedForeground: "color-mix(in srgb, #A3A3A3 80%, var(--background))",
      accent: "#2A2A2A",
  ...
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      muted: "#FDF2F6",
      mutedForeground: "color-mix(in srgb, #7A6570 80%, var(--background))",
      accent: "#F5D0DE",
  ...
  makeBuiltinTheme({
    ...
    tokens: {
      ...
      muted: "#2E222A",
      mutedForeground: "color-mix(in srgb, #C4AAB8 80%, var(--background))",
      accent: "#3D2F38",
