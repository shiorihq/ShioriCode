...
export function createWsNativeApi(): NativeApi {
  ...
  const api: NativeApi = {
    ...
    computer: {
      ...
      listApps: (input) => rpcClient.computer.listApps(input),
      focusApp: (input) => rpcClient.computer.focusApp(input),
      focusWindow: (input) => rpcClient.computer.focusWindow(input),
      click: (input) => rpcClient.computer.click(input),
      doubleClick: (input) => rpcClient.computer.doubleClick(input),
      rightClick: (input) => rpcClient.computer.rightClick(input),
      move: (input) => rpcClient.computer.move(input),
      drag: (input) => rpcClient.computer.drag(input),
      ...
      wait: (input) => rpcClient.computer.wait(input),
    },
  };
