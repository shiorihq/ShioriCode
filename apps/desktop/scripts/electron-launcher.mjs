// This file mostly exists because we want dev mode to say "ShioriCode (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "ShioriCode (Dev)" : "ShioriCode (Alpha)";
