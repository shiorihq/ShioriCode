...
import { CheckpointRef } from "contracts";
    ...
    yield* Effect.acquireUseRelease(
      ...
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "ShioriCode",
          GIT_AUTHOR_EMAIL: "shioricode@users.noreply.github.com",
          GIT_COMMITTER_NAME: "ShioriCode",
          GIT_COMMITTER_EMAIL: "shioricode@users.noreply.github.com",
        };
