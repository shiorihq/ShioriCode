...
export interface ProviderServiceShape {
  ...
  /**
   * Steer a running provider turn, if the bound provider supports it.
   */
  ...
  /**
   * Read account usage from providers that expose reliable usage data.
   */
  readonly readUsage: (
    provider: "codex" | "claudeAgent",
  ) => Effect.Effect<CodexUsageSnapshot | ClaudeUsageSnapshot, ProviderServiceError>;
