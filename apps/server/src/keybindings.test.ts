import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "contracts";
...
import { KeybindingsConfigError } from "contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "shioricode-keybindings-test-",
        }),
      ),
    ),
  );
