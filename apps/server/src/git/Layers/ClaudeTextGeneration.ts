...
import { ClaudeModelSelection } from "contracts";
import { resolveApiModelId } from "shared/model";
...
import { normalizeClaudeModelOptionsWithCapabilities } from "shared/model";
