...
import {
  ...
  AgentConfigInit,
  CreateStrategyArgs,
  cloneCapabilitiesConfig,
  cloneMcpServerConfig,
  cloneSystemInstructions,
  ConnectionStrategy,
} from "../connection.js";
...
export class LocalAgentConfig extends AgentConfig {
  ...
  #applyShorthandConfigs(init: LocalAgentConfigInit): void {
  ...
  createStrategy(args: CreateStrategyArgs): ConnectionStrategy {
    ...
    const systemInstructions =
      typeof this.systemInstructions === "string"
  ...
  clone(): LocalAgentConfig {
    const clone = Object.create(LocalAgentConfig.prototype) as LocalAgentConfig;
