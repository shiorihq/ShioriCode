...
export const KanbanItemId = makeEntityId("KanbanItemId");
export type KanbanItemId = typeof KanbanItemId.Type;
export const KanbanItemAssigneeId = makeEntityId("KanbanItemAssigneeId");
export type KanbanItemAssigneeId = typeof KanbanItemAssigneeId.Type;
export const KanbanItemNoteId = makeEntityId("KanbanItemNoteId");
export type KanbanItemNoteId = typeof KanbanItemNoteId.Type;
export const GoalItemId = KanbanItemId;
export type GoalItemId = KanbanItemId;
export const GoalItemAssigneeId = KanbanItemAssigneeId;
export type GoalItemAssigneeId = KanbanItemAssigneeId;
export const GoalItemNoteId = KanbanItemNoteId;
export type GoalItemNoteId = KanbanItemNoteId;
